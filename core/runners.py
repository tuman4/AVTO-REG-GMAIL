...
async def async_playwright_flow(i, num_accounts, username, first_name, last_name,
    ...
    try:
        ...
        if flow_mode == "youtube":
            ...
            signup_urls = [
                "https://accounts.google.com/lifecycle/steps/signup/name?continue=https%3A%2F%2Fmyaccount.google.com%3Futm_source%3Daccount&dsh=S1527412391%3A" + str(random.randint(1000000000, 9999999999)) + "&flowEntry=SignUp&flowName=GlifWebSignIn&hl=en&theme=gli",
                ...
                "https://accounts.google.com/lifecycle/steps/signup/name?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&flowEntry=SignUp&flowName=GlifWebSignIn&hl=en-US&service=mail&theme=gli",
                "https://accounts.google.com/signup/v2/createaccount?biz=false&flowName=GlifWebSignIn&flowEntry=SignUp&hl=en",
                "https://accounts.google.com/lifecycle/steps/signup/name?continue=https%3A%2F%2Fplay.google.com&flowEntry=SignUp&flowName=GlifWebSignIn&hl=en&theme=gli",
            ]
